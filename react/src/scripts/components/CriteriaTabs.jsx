...
const CriteriaTabs = React.createClass({
    ...
    setKnownOptions: function(){
        ...
        this.options.currency_exchange_loss_liability = {label: "Currency Loss", match: '', multi: false, select_options:[{value: '', label:"Show All"}, {value:'shared', label:"Shared Loss"},{value:'none', label:"No Currency Loss"}]}
            ...
            <Tabs animation={false} activeKey={this.state.activeTab} onSelect={this.tabSelect}>
                ...
                <Tab eventKey={1} title="Borrower" className="ample-padding-top">
                    <Col lg={8}>
                        ...
                        <For each='name' index='i' of={['country_code','sector','activity','themes','tags','currency_exchange_loss_liability','bonus_credit_eligibility','sort']}>

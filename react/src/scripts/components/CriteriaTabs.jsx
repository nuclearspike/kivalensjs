...
allOptions.age = {min: 19, max: 100, label: 'Age', helpText: "KivaLens looks for variations of the pattern '20-99 year(s) old' in the description and uses the first one mentioned... which may be the borrower's mother's age. Read the description to double-check it! Just over half of the loans have ages that can be pulled out, you must set the lower slider to something other than 'min' or loans with no ages found will be included as well."}

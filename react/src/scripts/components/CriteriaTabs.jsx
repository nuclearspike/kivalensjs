...
allOptions.still_needed = {min: 0, max: 5000, step: 25, label: 'Still Needed ($)', helpText: "How much is still needed to fully fund the loan. Loan Amount - Funded Amount - Basket Amount. Set the lower bound to $25 to exclude loans that are fully funded with basket amounts. Set both the lower and upper bound to $25 to find loans where they just need one more lender."}
...
const SelectRow = React.createClass({
    ...
    render(){
        ...
        return <Row>
            <Col md={3}>
                {options.helpText ?
                    <OverlayTrigger rootClose={true} trigger={["hover","focus","click"]}

...
allOptions.dollars_per_hour = {min: 0, max: 1000, label: '$/Hour', helpText: "Funded Amounts + Basket Amounts / Time since posting. This can help you find the fastest funding loans."}

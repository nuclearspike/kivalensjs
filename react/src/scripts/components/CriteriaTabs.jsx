...
allOptions.currency_exchange_loss_liability = {label: "Currency Loss", multi: true, select_options:[{value: '', label:"Show All"}, {value:'shared', label:"Shared Loss"},{value:'none', label:"No Currency Exchange Loss"},{value:'partner', label:'Partner covers'}]}

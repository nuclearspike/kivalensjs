...
allOptions.sort = {label: 'Sort', multi: false, select_options: [{"value": null, label: "Date half is paid back, then 75%, then full (default)"},{value: "final_repayment", label: "Final repayment date"},{value:'newest',label:'Newest'},{value:'expiring',label:'Expiring'},{value:'popularity',label:'Popularity ($/hour)'},{value: 'still_needed', label: "$ Still Needed"}]}
...
const SelectRow = React.createClass({
    ...
    getOptions(input, callback){
        callback(null, {options: allOptions[this.props.name].select_options, complete: true})
    },
    render(){
            ...
            <Col md={9}>
                <table style={{width:'100%',borderCollapse:'separate'}}>
                    ...
                    <tr>
                        ...
                        <td style={{width:'100%'}}>
                            <Select.Async simpleValue multi={options.multi} ref='select'

        ...
        return (
            <Grid>
                ...
                <Col md={12}>
                    ...
                    <Input type="checkbox" label={`Ignore Loans over ${this.state.maxRepaymentTerms} months for repayment term (stop downloading)`} checkedLink={this.linkState('maxRepaymentTerms_on')} />

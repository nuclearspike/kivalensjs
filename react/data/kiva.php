...
$dest_host = "www.kiva.org";

// http://www.kivalens.org/kiva.php/ajax/getSuperGraphData?sliceBy=gender&include=all&measure=count&subject_id=nuclearspike&type=lender&granularity=monthly
...
if( strpos($proxy_request_url, 'kiva.php') === 0 )
{
    $proxy_request_url = ltrim(substr($proxy_request_url, strlen('kiva.php')), '/');
}
